...
def render_welcome_page():
    ...
    html_content = """<div style="max-width: 520px; margin: 30px auto; background-color: #ffffff; border: 1px solid #c4c9ac; border-radius: 16px; padding: 36px; box-shadow: 0px 4px 20px rgba(0,0,0,0.03);">
